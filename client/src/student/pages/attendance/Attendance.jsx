  ...
  const fetchAttendance = useCallback(async (y, m) => {
    ...
    try {
      ...
      if (!ct.includes("application/json"))
        throw new Error(
          `Server returned non-JSON (status ${res.status}). Check API_BASE.`,
        );
        ...
        <div className="att-bottom-grid a3">
                  ...
                  return (
                    <div className="att-cal-grid">
                      ...
                      {calendarDays.map((item, idx) => {
                        ...
                        const cellLabel =
                          declaredName ||
                          (isWeekend && isHoliday ? weekendLabel : null);
                        ...
                        return (
                          <div
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              setActiveTooltip(
                                tooltipText ? (isOpen ? null : idx) : null,
                              );
                            }}
                          >
                            ...
                            {cellLabel && (
                              <span
                                style={{
                                  fontSize: "clamp(0.38rem, 1.5vw, 0.46rem)",
                                  fontWeight: 700,
                                  maxWidth: "90%",
                                  overflow: "hidden",
          ...
          <div className="att-card" style={{ padding: "20px 18px" }}>
            ...
            >
              ...
              <span style={{ fontSize: 12, fontWeight: 800, color: C.dark }}>
                {pct}%
              </span>
            </div>
            <div
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
              ...
              {stats.absent > 0 && (
                ...
                >
                  ...
                  >
                    {stats.absent} absent day{stats.absent > 1 ? "s" : ""} this
                    month
                  </div>
                </div>
              )}
