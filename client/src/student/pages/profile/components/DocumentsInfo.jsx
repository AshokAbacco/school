...
function FileTypeIcon({ fileType, size = 15 }) {
  if (fileType?.startsWith("image/"))
    return <ImageIcon size={size} color={C.light} />;
...
function DocCard({ doc, onView }) {
  const label =
    doc.customLabel || DOC_LABELS[doc.documentName] || doc.documentName;
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          height: 3,
          background: doc.isVerified ? "#16a34a" : "#d97706",
        }}
      />
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 -8px 60px rgba(56,73,89,0.30), 0 24px 80px rgba(56,73,89,0.20)",
          display: "flex",
          flexDirection: "column",
          overflow: "hidden",
          fontFamily: "'Inter', sans-serif",
        ...
        >
          ...
          >
            ...
            {state === "ready" && url && (
              ...
              >
                <Download size={11} />
                <span style={{ display: "none" }} className="pf-dl-label">
                  Download
                </span>
              </a>
            )}
        ...
        >
          ...
          {state === "error" && (
            ...
            >
              ...
              <button onClick={fetchUrl} style={retryBtn}>
          ...
          {state === "expired" && (
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: C.mid, marginTop: 4 }}>
                  Secure links expire after 1 hour.
                </div>
              </div>
              <button onClick={fetchUrl} style={retryBtn}>
          ...
          {state === "ready" && url && !isImage && !isPdf && (
            ...
            >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                style={{ ...retryBtn, textDecoration: "none" }}
              >
...
export default function DocumentsInfo({ docs, loading, error, onRetry }) {
  ...
  if (!docs.length)
    return <Empty message="No documents have been uploaded yet." />;
