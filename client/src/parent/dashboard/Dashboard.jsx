...
const Card = ({ children, style = {} }) => (
  <div className="sdb-card" style={{ overflow: "hidden", ...style }}>
    {children}
  </div>
);
  ...
  return (
    <div style={{ marginBottom: 18 }}>
      ...
      <div
        ...
        style={{ display: "flex", gap: 9, overflowX: "auto", paddingBottom: 3 }}
      >
        {children.map((child) => {
          ...
          return (
            <button
              ...
              style={{
                ...
                border: active
                  ? `1.5px solid ${C.light}`
                  : `1.5px solid ${C.glassBorder}`,
                background: active ? "rgba(136,189,242,0.14)" : C.white,
                transition: "all 0.15s",
                boxShadow: active
                  ? "0 2px 10px rgba(136,189,242,0.22)"
                  : "none",
                fontFamily: "'Inter',sans-serif",
              }}
            >
        ...
        <div
          style={{
            ...
            background: dark
              ...
              : "rgba(136,189,242,0.18)",
            border: `1px solid ${
              dark ? "rgba(255,255,255,0.18)" : "rgba(136,189,242,0.28)"
            }`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
...
function TodaySchedule({ slots, loading }) {
  ...
  const allDone =
    slots.length > 0 &&
    slots.every((s) => getStatus(s.startTime, s.endTime) === "done");
    ...
    <Card>
      ...
      <div style={{ padding: "10px 14px 12px" }}>
        {loading ? (
          ...
          <EmptyState icon={Calendar} text="No classes today" />
        ) : (
                ...
                <div
                  ...
                  style={{
                    ...
                    background: isCurrent
                      ? "rgba(136,189,242,0.14)"
                      : "transparent",
                    border: `1.5px solid ${
                      isCurrent ? "rgba(136,189,242,0.32)" : "transparent"
                    }`,
                    opacity: rowOpacity,
                  }}
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <p
                      className="sdb-truncate"
                      style={{ margin: "2px 0 0", fontSize: 10, color: C.mid }}
                    >
                      {slot.teacher}
                    </p>
                  </div>
                  <div
                    style={{ textAlign: "right", flexShrink: 0, maxWidth: 68 }}
                  >
                    <p
                      style={{
                        margin: 0,
    ...
    <Card>
      ...
      <div style={{ padding: "12px 14px" }}>
        {loading ? (
          ...
          <EmptyState icon={BookMarked} text="No results published yet" />
        ) : (
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            {marks.map((m) => {
                ...
                >
                  ...
                  <div style={{ textAlign: "right", flexShrink: 0 }}>
                    ...
                    >
                      {m.marksObtained}
                      <span
                        style={{ fontSize: 10, fontWeight: 400, color: C.mid }}
                      >
                        /{m.maxMarks}
                      </span>
                    </p>
    ...
    <Card>
      ...
      <div style={{ padding: "12px 14px" }}>
        {loading ? (
          ...
          <EmptyState icon={Target} text="No upcoming exams" />
        ) : (
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: urgent
                      ? "rgba(56,73,89,0.07)"
                      : "rgba(136,189,242,0.09)",
                    border: `1.5px solid ${
                      urgent ? "rgba(56,73,89,0.18)" : "rgba(136,189,242,0.20)"
                    }`,
                  }}
                >
                  <div
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        borderRadius: 20,
                        flexShrink: 0,
                        background: urgent ? C.dark : C.light,
                        color: C.white,
                      }}
                    >
                      {days === 0
                  ...
                  >
                    {[
                      { icon: Calendar, label: fmtDay(ex.examDate) },
                      { icon: Clock, label: fmtTime(ex.startTime?.toString()) },
                    ].map(({ icon: Ic, label }) => (
                      <span
                        key={label}
                        style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              {[
                {
                  label: "Present",
                  val: attendance?.presentDays ?? 0,
                  dot: C.dark,
                },
                {
                  label: "Absent",
                  val: attendance?.absentDays ?? 0,
                  dot: C.light,
                },
                ...
                >
                  ...
                  <span
                    className="sora"
                    style={{ fontSize: 12, fontWeight: 800, color: C.dark }}
                  >
                    {val}
                  </span>
                </div>
    ...
    <Card>
      ...
      <div style={{ padding: "12px 14px" }}>
        {loading ? (
          ...
          <EmptyState icon={Star} text="No awards yet" />
        ) : (
    ...
    <Card>
      ...
      <div style={{ padding: "12px 14px" }}>
        {loading ? (
          ...
          <EmptyState icon={Users} text="No upcoming meetings" />
        ) : (
                ...
                >
                  ...
                  >
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        {[
                          { icon: Calendar, label: fmtDay(m.meetingDate) },
                          { icon: Clock, label: fmtTime(m.startTime) },
                        ].map(({ icon: Ic, label }) => (
                          <span
                            key={label}
                            style={{
                    ...
                    <span
                      style={{
                        ...
                        flexShrink: 0,
                        background: `${
                          acc === C.pale ? "rgba(189,221,252,0.40)" : acc + "20"
                        }`,
    ...
    (async () => {
      ...
      try {
        ...
        const list = raw.map((s) => ({
          ...
          profileImage: s.profileImage || s.personalInfo?.profileImage || null,
        }));
        setChildren(list);
  ...
  const statCards = [
    {
      ...
      sub: d?.attendance
        ? `${d.attendance.presentDays} / ${d.attendance.totalDays} days`
        : null,
    },
    {
      label: "Latest Grade",
      ...
      sub: d?.latestResult
        ? `${
            d.latestResult.assessmentGroup ?? d.latestResult.termName ?? ""
          }`.trim() || null
        : null,
    },
    {
      ...
      sub: d?.activities
        ? `${d.activities.achievements} achievement${
            d.activities.achievements === 1 ? "" : "s"
          }`
        : null,
    },
    {
      ...
      sub: d?.upcomingExams?.[0]
        ? `Next: ${d.upcomingExams[0].subject}`
        : "None scheduled",
    },
  ];
  ...
  return (
    <>
      ...
      {toast && (
        ...
        >
          <AlertCircle size={14} color={C.mid} />
          {toast.msg}
        </div>
      )}

      <div
        className="sdb sdb-page"
        style={{
          minHeight: "100vh",
          background: C.bg,
          backgroundImage: `
          ...
          <>
            ...
            >
              ...
              >
                ...
                <div style={{ minWidth: 0 }}>
                  ...
                  {!isSmall && (
                    <p
                      style={{ margin: "2px 0 0", fontSize: 11, color: C.mid }}
                    >
                      {TODAY_LABEL}
                    </p>
                  )}
            ...
            {!selectedChild && (
              ...
              >
                ...
                <p style={{ color: C.mid, fontSize: 13, margin: 0 }}>
                  Select a child above to view their dashboard.
                </p>
              </div>
            )}
            ...
            {selectedChild && (
              <>
                {/* Stat cards */}
                <div
                  className="sdb-a2 sdb-stat-grid"
                ...
                {/* Schedule + Results */}
                <div
                  className="sdb-a3 sdb-mid-grid"
                  style={{ marginBottom: isMobile ? 14 : 16 }}
                >
                  <TodaySchedule
                    slots={d?.todaySchedule ?? []}
                    loading={loading}
                  />
                  <RecentMarks
                    marks={d?.recentMarks ?? []}
