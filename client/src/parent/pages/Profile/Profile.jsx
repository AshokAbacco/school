...
import {
  ...
  PROFILE_CSS,
  initials,
} from "../../../student/pages/profile/components/shared.jsx";
...
export default function ParentProfile() {
  ...
  // ── Derived ───────────────────────────────────────────────────
  const enrollment =
    profileData?.enrollments?.find((e) => e.academicYear?.isActive) ??
            ...
            {!selectedChild && (
              ...
              >
                ...
                <p style={{ color: C.mid, fontSize: 13, margin: 0 }}>
                  Select a child above to view their profile.
                </p>
              </div>
            )}
