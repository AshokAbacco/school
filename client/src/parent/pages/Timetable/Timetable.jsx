    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        >
          ...
          >
            {slot.subject?.name ??
              (isLunch ? "Lunch Break" : slot.label ?? "Break")}
          </span>
          {slot.subject?.code && (
            <span
              style={{
...
export default function ParentTimetable() {
  ...
  const classSlots = slots.filter(
    (s) =>
      s.slotType !== "BREAK" &&
      s.slotType !== "LUNCH" &&
      s.slotType !== "SHORT_BREAK" &&
      s.slotType !== "LUNCH_BREAK" &&
      s.slotType !== "PRAYER" &&
      s.slotType !== "OTHER",
  );
                  ...
                  {[
                    {
                      ...
                      accent: C.sky,
                      icon: (
                        <Calendar size={isMobile ? 18 : 22} color={C.sky} />
                      ),
                    },
                    {
                      label: "SCHOOL HOURS",
                    ...
                    },
                    {
                      ...
                      accent: C.green,
                      icon: (
                        <BookOpen size={isMobile ? 18 : 22} color={C.green} />
                      ),
                    },
                  ].map((card, idx) => (
                    <div
                  ...
                  >
                    <div>
                      ...
                      >
                        ...
                        {classSlots.length !== 1 ? "es" : ""} · {slots.length}{" "}
                        total slots
                      </p>
                    </div>
