...
function PrimaryBtn({ children, onClick, loading, disabled, compact }) {
  return (
    <button
      ...
      onMouseEnter={(e) => {
        if (!loading && !disabled)
          e.currentTarget.style.background = C.deepDark;
      }}
      onMouseLeave={(e) => {
        if (!loading && !disabled) e.currentTarget.style.background = C.deep;
      }}
    >
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 9,
        border: danger
          ? `1.5px solid ${C.danger}44`
          : `1.5px solid ${C.borderLight}`,
        background: danger ? `${C.danger}08` : C.white,
      ...
      onMouseEnter={(e) =>
        (e.currentTarget.style.background = danger ? `${C.danger}12` : C.bg)
      }
      onMouseLeave={(e) =>
        (e.currentTarget.style.background = danger ? `${C.danger}08` : C.white)
      }
    >
      {children}
    </button>
    ...
    >
      <div
        ...
        style={{
          ...
          border: `1.5px solid ${C.borderLight}`,
          boxShadow: "0 24px 64px rgba(56,73,89,0.25)",
          width: "100%",
          maxWidth: isMobile ? "100%" : wide ? 640 : 440,
          maxHeight: isMobile ? "92dvh" : "calc(100dvh - 24px)",
          display: "flex",
          flexDirection: "column",
          animation: isMobile ? "slideUp 0.3s ease" : "modalIn 0.25s ease",
        }}
      >
        ...
        <div
          style={{
            ...
            alignItems: "center",
            justifyContent: "space-between",
            borderRadius: isMobile ? "22px 22px 0 0" : "22px 22px 0 0",
...
function ActivityFormModal({
  ...
  const save = async () => {
    if (!form.name.trim())
      return pushToast("Activity name is required", "error");
    setSaving(true);
    try {
      isEdit
        ? await apiFetch(`${API}/${editing.id}`, {
            method: "PUT",
            body: JSON.stringify({ ...form, classSectionIds: form.classIds }),
          })
        : await apiFetch(API, {
            method: "POST",
            body: JSON.stringify({ ...form, classSectionIds: form.classIds }),
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        >
          ...
          <div>
            <Label required>Participation</Label>
            <PillGroup
              options={[
                { value: "TEAM", label: "Team", color: C.deep },
                { value: "INDIVIDUAL", label: "Individual", color: C.success },
              ]}
...
function EventFormModal({
  ...
  const [form, setForm] = useState({
    ...
    eventDate: toLocal(editing?.eventDate),
    venue: editing?.venue ?? "",
    academicYearId:
      editing?.academicYearId ??
      academicYears.find((y) => y.isActive)?.id ??
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        >
          <div>
            ...
            <PillGroup
              options={Object.entries(EVENT_TYPE_META).map(([v, m]) => ({
                value: v,
                label: m.label,
                color: m.color,
              }))}
          ...
          <div>
            ...
            <PillGroup
              options={[
                { value: "INDIVIDUAL", label: "Solo", color: C.success },
                { value: "TEAM", label: "Team", color: C.deep },
                { value: "BOTH", label: "Both", color: C.sky },
              ]}
        ...
        <div>
          ...
          <PillGroup
            options={Object.entries(EVENT_STATUS_META).map(([v, m]) => ({
              value: v,
              label: m.label,
              color: m.color,
            }))}
  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1.5px solid ${C.borderLight}`,
        padding: compact ? "16px 14px 14px" : "24px 22px 20px",
        display: "flex",
        flexDirection: compact ? "row" : "column",
        alignItems: compact ? "center" : "flex-start",
        gap: compact ? 12 : 18,
        boxShadow: hov
          ? `0 16px 48px rgba(56,73,89,0.13)`
    ...
    >
      <div
        style={{
          ...
          right: 0,
          height: 3,
          background: `linear-gradient(90deg, ${color}, ${C.slate})`,
          opacity: hov ? 1 : 0.6,
        }}
      />
      <div
    ...
    >
      ...
      <div className="fade-up" style={{ marginBottom: isMobile ? 20 : 28 }}>
        ...
        >
          ...
          >
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <h1
                style={{
                  margin: 0,
                  fontSize: isXs ? 20 : isMobile ? 24 : 32,
                  fontWeight: 900,
                  color: C.text,
                  letterSpacing: "-0.5px",
          ...
          >
            <OutlineBtn
              onClick={() => setModal({ type: "activity", data: null })}
              compact={isMobile}
            >
              <Plus size={14} /> New Activity
            </OutlineBtn>
            <PrimaryBtn
              onClick={() => setModal({ type: "event", data: null })}
              compact={isMobile}
            >
              ...
              {["activities", "events"].map((t) => (
                <button
                  ...
                  style={{
                    ...
                    color: tab === t ? C.deep : C.textLight,
                    borderBottom:
                      tab === t
                        ? `2px solid ${C.deep}`
        ...
        <div style={{ padding: isMobile ? 14 : 24 }}>
          {loading ? (
            ...
            >
              ...
              >
                {tab === "activities" ? (
                  <BookOpen size={24} color={C.slate} />
                ) : (
                  <Trophy size={24} color={C.slate} />
                )}
              </div>
              <p
                style={{
              ...
              {filtered.map((item, idx) => (
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow =
                      "0 10px 25px rgba(56,73,89,0.08)";
                ...
                >
                  ...
                  >
                    ...
                    >
                      {tab === "activities" ? (
                        <BookOpen size={16} color={C.deep} />
                      ) : (
                        <Trophy size={16} color={C.warn} />
                      )}
                    </div>
                    <div style={{ display: "flex", gap: 6 }}>
                      <button
                        onClick={() =>
                          setModal({
                            type: tab === "activities" ? "activity" : "event",
                            data: item,
                          })
                        }
                        style={{
                      ...
                      {item.status && EVENT_STATUS_META[item.status] && (
                        <span
                          style={{
                            ...
                            borderRadius: 6,
                            background: `${
                              EVENT_STATUS_META[item.status].color
                            }15`,
                            color: EVENT_STATUS_META[item.status].color,
                          }}
                        >
