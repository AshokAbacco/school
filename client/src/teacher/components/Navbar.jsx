...
async function fetchBirthdayNotifications() {
  ...
  try {
    sessionStorage.setItem(BDAY_CACHE_KEY, JSON.stringify(json.data));
  } catch {
    /* storage full */
  }
  return json.data;
...
function BellPanel({ data, loading, error, onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ fontWeight: 700, fontSize: 14, color: "#384959" }}>
          Notifications
        </span>
        <button
          onClick={onClose}
      ...
      <div style={{ maxHeight: 520, overflowY: "auto", overflowX: "hidden" }}>
        ...
        {!loading && !error && (!data || data.count === 0) && (
          <div style={{ padding: "36px 16px", textAlign: "center" }}>
            ...
            />
            <p style={{ color: "#6A89A7", fontSize: 13 }}>
          ...
          <>
            <div
              style={{
                ...
                border: `1px solid ${
                  isTeacherBirthday ? "#fcd34d" : "#BDDDFC"
                }`,
                padding: "12px 14px",
              }}
            >
              ...
              return (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    {lastMsg?.createdAt && (
                      <p
                        style={{ fontSize: 10, color: "#88BDF2", marginTop: 2 }}
                      >
                  ...
                  <MessageSquare
                    size={14}
                    style={{ color: "#88BDF2", flexShrink: 0, marginTop: 4 }}
                  />
                </div>
              );
            })}
...
export default function Navbar({ onMenuClick, user }) {
  ...
  const totalUnreadChat = chatNotifs.reduce(
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="relative" ref={bellRef}>
            <button
              ...
              style={{
                color: hasBirthday ? "#f97316" : "#6A89A7",
                background: "none",
                border: "none",
                cursor: "pointer",
              }}
